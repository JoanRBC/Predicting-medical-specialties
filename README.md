...
Nowadays, and specially in the current situation every country faces due to COVID-19, it is important to be able to aid healthcare workers redirect each patient to the specific medical specialty just by knowing their symptoms or medical transcriptions. This would greatly reduce the contact between patients and workers, the attendance time, and probably save many lives.  
